...
export const iconProps = { size: 24, strokeWidth: 2, color: 'currentColor' };

export function Bell({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>;
}

export function Calendar({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function ArrowRight({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function Quote({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill={color}><path d="M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V21c0 1 0 1 1 1z"/><path d="M15 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2h.75c0 2.25.25 4-2.75 4v3c0 1 0 1 1 1z"/></svg>;
}

export function Users({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function Briefcase({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function MapPin({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function Clock({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function BookOpen({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function Bus({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="6" width="18" height="12" rx="2"/><path d="M6 18v2"/><path d="M18 18v2"/><circle cx="7.5" cy="15.5" r="1.5"/><circle cx="16.5" cy="15.5" r="1.5"/></svg>;
}

export function Shield({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function CreditCard({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function Pin({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function Filter({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function ChevronDown({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function ChevronLeft({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function ChevronRight({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function HelpCircle({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
...
export function MessageCircle({ size = 24, color = 'currentColor' }: { size?: number; color?: string }) {
